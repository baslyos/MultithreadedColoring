...
class DrawingBoard2 extends JPanel {
    ...
    public DrawingBoard2() {
        ...
        bImage = new BufferedImage(this.getPreferredSize().width, this.getPreferredSize().height, BufferedImage.TYPE_INT_ARGB);
    ...
    private void drawBasicShape(Graphics g) {
        ...
        for (int i = 0; i < jerry.length; i++) {
            if (jerry[i].type.equalsIgnoreCase("elipse")) {
                ...
                double x = jerry[i].x;
                double y = jerry[i].y;
                double k = Math.sqrt(Math.pow(x1 - x, 2) + Math.pow(y1 - y, 2)) + Math.sqrt(Math.pow(x2 - x, 2) + Math.pow(y2 - y, 2));
                double a = Math.pow(x1, 2) - (2 * x * x1) + Math.pow(y1, 2) - Math.pow(k, 2) - Math.pow(x2, 2) + (2 * x * x2) - Math.pow(y2, 2);
                double A = (4 * Math.pow(y2, 2)) + (4 * Math.pow(y1, 2)) - (8 * y1 * y2) - (4 * Math.pow(k, 2));
                double B = (4 * a * y2) - (4 * a * y1) + (8 * Math.pow(k, 2) * y2);
                double C = Math.pow(a, 2) - (4 * Math.pow(k, 2) * Math.pow(x2, 2)) - (4 * Math.pow(k, 2) * Math.pow(x, 2)) + (8 * Math.pow(k, 2) * x * x2) - (4 * Math.pow(k, 2) * Math.pow(y2, 2));
                ...
                if (Ya.equals(Yb)) {
                    ...
                    if (x < x1) {
                        for (double xn = x + 1;; xn += 1) {
                            a = Math.pow(x1, 2) - (2 * xn * x1) + Math.pow(y1, 2) - Math.pow(k, 2) - Math.pow(x2, 2) + (2 * xn * x2) - Math.pow(y2, 2);
                            A = (4 * Math.pow(y2, 2)) + (4 * Math.pow(y1, 2)) - (8 * y1 * y2) - (4 * Math.pow(k, 2));
                            B = (4 * a * y2) - (4 * a * y1) + (8 * Math.pow(k, 2) * y2);
                            C = Math.pow(a, 2) - (4 * Math.pow(k, 2) * Math.pow(x2, 2)) - (4 * Math.pow(k, 2) * Math.pow(xn, 2)) + (8 * Math.pow(k, 2) * xn * x2) - (4 * Math.pow(k, 2) * Math.pow(y2, 2));
                ...
                a = Math.pow(x1, 2) + Math.pow(y1, 2) - (2 * y * y1) - Math.pow(k, 2) - Math.pow(x2, 2) - Math.pow(y2, 2) + (2 * y * y2);
                A = (4 * Math.pow(x2, 2)) + (4 * Math.pow(x1, 2)) - (8 * x2 * x1) - (4 * Math.pow(k, 2));
                B = (4 * a * x2) - (4 * a * x1) + (8 * Math.pow(k, 2) * x2);
                C = Math.pow(a, 2) - (4 * Math.pow(k, 2) * Math.pow(x2, 2)) - (4 * Math.pow(k, 2) * Math.pow(y2, 2)) - (4 * Math.pow(k, 2) * Math.pow(y, 2)) + (8 * Math.pow(k, 2) * y * y2);
                ...
                if (Xa.equals(Xb)) {
                    ...
                    if (y > y1) {
                        for (double yn = y - 1;; yn -= 1) {
                            a = Math.pow(x1, 2) + Math.pow(y1, 2) - (2 * yn * y1) - Math.pow(k, 2) - Math.pow(x2, 2) - Math.pow(y2, 2) + (2 * yn * y2);
                            A = (4 * Math.pow(x2, 2)) + (4 * Math.pow(x1, 2)) - (8 * x2 * x1) - (4 * Math.pow(k, 2));
                            B = (4 * a * x2) - (4 * a * x1) + (8 * Math.pow(k, 2) * x2);
                            C = Math.pow(a, 2) - (4 * Math.pow(k, 2) * Math.pow(x2, 2)) - (4 * Math.pow(k, 2) * Math.pow(y2, 2)) - (4 * Math.pow(k, 2) * Math.pow(yn, 2)) + (8 * Math.pow(k, 2) * yn * y2);
                ...
                g.drawLine((int) Math.round(jerry[i].x1), (int) Math.round(jerry[i].y1), (int) Math.round(jerry[i].x2), (int) Math.round(jerry[i].y2));
            }
        }
    }
...
//    }
    public synchronized boolean setPixelRGB(Point pixelLocation) {
        if (pixelLocation.x > -1 && pixelLocation.x < bImage.getWidth() && pixelLocation.y > -1 && pixelLocation.y < bImage.getHeight()
    ...
    synchronized StartingFillInfo initFill(Point pixelLocation) {
        ...
        if (bImage.getRGB(pixelLocation.x, pixelLocation.y) == blankColor.getRGB()) {
            ...
            while (true) {
                if (x > 0 && y > 0 && (bImage.getRGB(x - 1, y) == blankColor.getRGB() || bImage.getRGB(x, y - 1) == blankColor.getRGB())
            ...
            y = pixelLocation.y;
            while (true) {
                if (x > 0 && y < bImage.getHeight() - 1 && (bImage.getRGB(x - 1, y) == blankColor.getRGB()
                        || bImage.getRGB(x, y + 1) == blankColor.getRGB()) && bImage.getRGB(x - 1, y + 1) == blankColor.getRGB()) {
                    //       bImage.setRGB(--x, ++y, coloredColor.getRGB());
                    --x;
                    ++y;
                } else {
            ...
            y = pixelLocation.y;
            while (true) {
                if (x < bImage.getWidth() - 1 && y > 0 && (bImage.getRGB(x + 1, y) == blankColor.getRGB()
                        || bImage.getRGB(x, y - 1) == blankColor.getRGB()) && bImage.getRGB(x + 1, y - 1) == blankColor.getRGB()) {
                    //      bImage.setRGB(++x, --y, coloredColor.getRGB());
                    ++x;
                    --y;
            ...
            y = pixelLocation.y;
            while (true) {
                if (x < bImage.getWidth() - 1 && y < bImage.getHeight() - 1 && (bImage.getRGB(x + 1, y) == blankColor.getRGB()
                        || bImage.getRGB(x, y + 1) == blankColor.getRGB()) && bImage.getRGB(x + 1, y + 1) == blankColor.getRGB()) {
                    //     bImage.setRGB(++x, ++y, coloredColor.getRGB());
                    ++x;
                    ++y;
